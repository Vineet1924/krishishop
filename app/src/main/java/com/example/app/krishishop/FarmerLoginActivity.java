    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnLogin.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Query query = databaseReference.orderByChild("usertype").equalTo("Farmer");
        ...
        txtForgotPassword.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                startActivity(new Intent(FarmerLoginActivity.this, Forgotpassword.class ));
            }
        });
    }
                ...
                mAuth.signInWithEmailAndPassword(email,password).addOnCompleteListener(FarmerLoginActivity.this,new OnCompleteListener<AuthResult>() {
                    ...
                    public void onComplete(@NonNull Task<AuthResult> task) {
                        ...
                        if (!task.isSuccessful()){
                            Toast.makeText(FarmerLoginActivity.this, "Login Failed..", Toast.LENGTH_SHORT).show();
                        }else{
                            startActivity(new Intent(FarmerLoginActivity.this, FarmerShopActivity.class));
