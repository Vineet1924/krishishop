...
public class ViewResellerProduct extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_view_reseller_product);

        ActionBar actionBar = getSupportActionBar();
        actionBar.setDisplayHomeAsUpEnabled(true);

        final Object o = getIntent().getSerializableExtra("detailReseller");
        ...
        if(product != null){
            ...
            txtPrice.setText("Price : ₹ "+product.getPrice()+"/kg");
    ...
    private void addToCart() {
        ...
        if (firebaseUser == null) {
            Intent intent = new Intent(ViewResellerProduct.this, ChoicesActivity.class);
            finish();
            ...
            firestore.collection("AddToCart").document("CurrentUser")
                    ...
                    .addOnCompleteListener(new OnCompleteListener<DocumentReference>() {
                        ...
                        public void onComplete(@NonNull Task<DocumentReference> task) {
                            Toast.makeText(ViewResellerProduct.this, "Added to cart", Toast.LENGTH_SHORT).show();
                            finish();
                        }
                    });
        }
